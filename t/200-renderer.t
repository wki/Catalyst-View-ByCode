...
note 'exported subs';
{
    can_ok 'Catalyst::View::ByCode::Renderer',
        qw(clear_markup init_markup get_markup);

    can_ok 'Catalyst::View::ByCode::Renderer', 
        qw(template block block_content
...
note 'print functionality';
{
    ...
    ok is_utf8(get_markup), 'unescaped markup is reported to be utf-8';
    ...
    ok is_utf8(get_markup), 'appended markup is reported to be utf-8';
    ...
    ok is_utf8(get_markup), 'append nested markup is reported to be utf-8';
    ...
    ok is_utf8(get_markup), 'escaped markup is reported to be utf-8';
}

note 'render() logic in PRINT';
{
    my $o = RenderMe->new();
    clear_markup();
